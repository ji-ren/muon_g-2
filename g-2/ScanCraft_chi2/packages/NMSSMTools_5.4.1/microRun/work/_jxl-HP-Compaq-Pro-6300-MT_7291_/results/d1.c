...
#include"num_out.h"
static void C1(REAL *);
extern DNN S1_omg_p25p25_u;
REAL S1_omg_p25p25_u(double GG, REAL * momenta,REAL*cb_coeff,int * err)
{REAL  ans=0;
REAL DP[6];
...
S[1]=V[172]*V[172];
C[14]=+16*S[0]*S[1];
C[13]=+32*V[468]*V[466]*V[172]*V[171];
...
S[7]=V[168]*V[168];
C[9]=+4*S[6]*S[7];
C[8]=+8*V[464]*V[462]*V[168]*V[167];
S[8]=V[462]*V[462];
S[9]=V[167]*V[167];
C[7]=+4*S[8]*S[9];
C[6]=+8*V[464]*V[460]*V[168]*V[166];
C[5]=+8*V[462]*V[460]*V[167]*V[166];
S[10]=V[15]*V[15]*V[15]*V[15]*V[15]*V[15];
C[4]=+S[10];
C[3]=+S[2];
C[2]=+S[3];
S[11]=V[122]*V[122];
