...
#include"num_in.h"
#include"num_out.h"
static void C34(REAL *);
extern DNN S34_omg_p25p25_u;
REAL S34_omg_p25p25_u(double GG, REAL * momenta,REAL*cb_coeff,int * err)
{REAL  ans=0;
REAL DP[6];
...
width[9]=0.; mass[9]=V[16];  Qtxt[9]="\1\4";
...
R=+C[87]+2*DP[0];
R*=(N/D);
Prop=1*(gtwidth_omg_p25p25_u? creal(Q1[13]):Q1[13])*(gswidth_omg_p25p25_u? creal(Q1[2]):conj(
 Q1[2]));
if(gswidth_omg_p25p25_u ) Prop=Prop*Q0[1]*Q0[3];
R*=creal(Prop);
 if(R>Fmax) Fmax=R; else if(R<-Fmax) Fmax=-R;
...
S[6]=V[214]*V[214];
C[113]=+S[0]*(S[0]*(V[213]*(V[213]*(4*(S[0]*(S[0]+S[1]-S[2]-S[3])+S[3]*(
 S[2]-S[1]))+S[2]*(S[2]-2*S[1])+S[4])+V[214]*(S[3]*(4*S[3]-8*S[0])+S[2]*(4*
 S[1]-2*S[2])+8*S[5]-2*S[4]))+S[6]*(4*(S[0]*(S[0]-S[1]+S[2]-S[3])+S[3]*(
 S[1]-S[2]))+S[2]*(S[2]-2*S[1])+S[4]))+S[3]*(V[213]*(S[1]*(2*(S[3]*(V[213]-
 V[214])+V[214]*S[1]+V[213]*S[2])-4*V[214]*S[2]-V[213]*S[1])+S[2]*(S[2]*(2*
 V[214]-V[213])-V[213]*S[3]))+S[6]*(S[2]*(2*S[1]-S[2]+S[3])-S[4])));
S[7]=V[2]*V[2]*V[2]*V[2];
C[112]=+S[0]*(V[213]*(V[213]*(S[2]*(S[2]-8*S[0]-2*S[1]+4*S[3])+S[1]*(8*S[0]+
 S[1]-4*S[3])+S[0]*(12*S[0]-8*S[3]))+V[214]*(S[3]*(4*S[3]-16*S[0])+S[2]*(4*
 S[1]-2*S[2])+24*S[5]-2*S[4]))+S[6]*(S[2]*(8*S[0]-2*S[1]+S[2]-4*S[3])+S[1]*(
 S[1]-8*S[0]+4*S[3])+S[0]*(12*S[0]-8*S[3])))+S[7]*(S[2]*(V[213]*(2*V[214]-
 V[213])-S[6]));
C[111]=+S[0]*(V[213]*(V[213]*(4*(S[1]-S[2]-S[3])+12*S[0])+V[214]*(24*S[0]-8*
 S[3]))+S[6]*(4*(S[2]-S[1]-S[3])+12*S[0]));
C[110]=+S[0]*(V[213]*(8*V[214]+4*V[213])+4*S[6]);
C[109]=+S[7]*(V[213]*(V[213]*(2*S[0]-S[1]+S[2])+V[214]*(2*(S[1]-S[2])-4*
 S[0]))+S[6]*(2*S[0]-S[1]+S[2]));
C[108]=+S[7]*(V[213]*(2*V[213]-4*V[214])+2*S[6]);
...
C[104]=+V[466]*V[458]*V[427]*V[125]*V[15]*V[1];
S[15]=V[466]*V[466];
S[16]=V[427]*V[427];
C[103]=+S[15]*S[16];
S[17]=V[11]*V[11]*V[11]*V[11];
C[102]=+S[0]*(V[213]*(S[2]*(2*(S[3]-S[1])+S[2]-4*S[0])+S[1]*(4*(S[0]-S[3])+
 S[1])+4*S[5])+V[214]*(S[1]*(2*(S[2]+S[3])-S[1])+S[0]*(4*(S[0]-S[3]))-
 S[17]));
C[101]=+S[0]*(V[213]*(4*(S[1]-S[2])+8*S[0])+V[214]*(8*S[0]-4*S[3]))+S[3]*(
 S[2]*(2*(V[213]-V[214])));
C[100]=+S[0]*(4*(V[214]+V[213]));
S[18]=V[1]*V[1];
C[99]=+V[466]*V[464]*V[458]*V[125]*S[18];
C[98]=+S[15]*V[464]*V[427]*V[15];
C[97]=+S[0]*(2*S[1]-S[2]);
C[96]=+S[2];
S[19]=V[464]*V[464];
C[95]=+S[15]*S[19];
C[94]=+S[0]*(2*(V[213]*(S[1]-S[2]-S[3])+V[214]*(S[2]-S[1]-S[3]))+S[0]*(4*(
 V[214]+V[213])))+S[3]*(S[2]*(V[213]-V[214])+S[1]*(V[214]-V[213]));
C[93]=+2*(V[213]*(S[1]-S[2]-S[3])+V[214]*(S[2]-S[1]-S[3]))+S[0]*(8*(V[214]+
 V[213]));
C[92]=+4*(V[214]+V[213]);
C[91]=+16*V[122]*V[121]*S[13]*S[14]*V[7]*V[3]*S[3];
C[90]=+V[468]*V[458]*V[439]*V[125]*V[15]*V[1];
S[20]=V[122]*V[122];
S[21]=V[121]*V[121];
S[22]=V[119]*V[119];
S[23]=V[7]*V[7];
...
C[88]=+V[468]*V[466]*V[439]*V[427];
C[87]=+2*S[0]+S[1]-S[2];
C[86]=+V[468]*V[466]*V[464]*V[439]*V[15];
C[85]=+S[0];
C[84]=+16*S[20]*S[21]*S[22]*S[23]*S[24]*S[18];
S[25]=V[468]*V[468];
S[26]=V[439]*V[439];
C[83]=+S[25]*S[26];
C[82]=+V[15]*(V[15]*(V[15]*(2*(V[15]*(V[213]*(S[1]-S[2]+S[3])+V[214]*(S[1]-
 S[2]-S[3]))+V[16]*(V[213]*(S[1]-S[2]-S[3])+V[214]*(S[2]-S[1]-S[3])))+S[0]*(
 V[16]*(4*(V[214]+V[213]))))+S[2]*(V[213]*(S[2]-2*S[1]+S[3])+V[214]*(2*S[1]-
 S[2]+S[3]))+S[1]*(S[3]*(V[214]-3*V[213])+S[1]*(V[213]-V[214])))+S[3]*(
 V[16]*(S[2]*(V[213]-V[214])+S[1]*(V[214]-V[213]))));
C[81]=+V[15]*(2*(V[15]*(V[213]*(S[1]-S[2]+S[3])+V[214]*(S[1]-S[2]-S[3]))+
 V[16]*(V[213]*(S[1]-S[2]-S[3])+V[214]*(S[2]-S[1]-S[3])))+S[0]*(V[16]*(8*(
 V[214]+V[213]))))+S[3]*(S[2]*(2*(V[213]-V[214])));
C[80]=+V[15]*(V[16]*(4*(V[214]+V[213])));
C[79]=+V[485]*V[481]*V[458]*V[125]*S[18];
C[78]=+V[485]*V[481]*V[466]*V[427];
C[77]=+V[15]*(V[15]*(V[15]*(2*(V[16]-V[15]))+3*S[1]-S[2])+V[16]*(S[1]-
 S[2]));
C[76]=+2*(V[15]*(V[16]-V[15])-S[2]);
C[75]=+V[485]*V[481]*V[466]*V[464];
C[74]=+V[15]*(2*V[16]*V[15]+S[1]-S[2]);
C[73]=+2*V[16];
C[72]=+V[485]*V[481]*V[468]*V[439];
S[27]=V[16]*V[16];
...
S[29]=V[481]*V[481];
C[69]=+S[28]*S[29];
C[68]=+V[15]*(V[15]*(V[15]*(2*(V[15]*(V[213]*(S[1]-S[2]+S[3])+V[214]*(S[1]-
 S[2]-S[3]))+V[17]*(V[213]*(S[1]-S[2]-S[3])+V[214]*(S[2]-S[1]-S[3])))+S[0]*(
 V[17]*(4*(V[214]+V[213]))))+S[2]*(V[213]*(S[2]-2*S[1]+S[3])+V[214]*(2*S[1]-
 S[2]+S[3]))+S[1]*(S[3]*(V[214]-3*V[213])+S[1]*(V[213]-V[214])))+S[3]*(
 V[17]*(S[2]*(V[213]-V[214])+S[1]*(V[214]-V[213]))));
C[67]=+V[15]*(2*(V[15]*(V[213]*(S[1]-S[2]+S[3])+V[214]*(S[1]-S[2]-S[3]))+
 V[17]*(V[213]*(S[1]-S[2]-S[3])+V[214]*(S[2]-S[1]-S[3])))+S[0]*(V[17]*(8*(
 V[214]+V[213]))))+S[3]*(S[2]*(2*(V[213]-V[214])));
C[66]=+V[15]*(V[17]*(4*(V[214]+V[213])));
C[65]=+V[506]*V[502]*V[458]*V[125]*S[18];
C[64]=+V[506]*V[502]*V[466]*V[427];
C[63]=+V[15]*(V[15]*(V[15]*(2*(V[17]-V[15]))+3*S[1]-S[2])+V[17]*(S[1]-
 S[2]));
C[62]=+2*(V[15]*(V[17]-V[15])-S[2]);
C[61]=+V[506]*V[502]*V[466]*V[464];
C[60]=+V[15]*(2*V[17]*V[15]+S[1]-S[2]);
C[59]=+2*V[17];
C[58]=+V[506]*V[502]*V[468]*V[439];
C[57]=+V[15]*(S[1]*(V[17]+V[16]+2*V[15])+S[2]*(-V[17]-V[16])+V[15]*(2*(
 V[17]*V[16]-S[0])));
C[56]=+2*(V[17]*V[16]-S[0]-S[2]);
C[55]=+V[506]*V[502]*V[485]*V[481];
S[30]=V[17]*V[17];
...
S[32]=V[502]*V[502];
C[52]=+S[31]*S[32];
C[51]=+V[15]*(V[15]*(V[15]*(2*(V[15]*(V[213]*(S[1]-S[2]+S[3])+V[214]*(S[1]-
 S[2]-S[3]))+V[18]*(V[213]*(S[1]-S[2]-S[3])+V[214]*(S[2]-S[1]-S[3])))+S[0]*(
 V[18]*(4*(V[214]+V[213]))))+S[2]*(V[213]*(S[2]-2*S[1]+S[3])+V[214]*(2*S[1]-
 S[2]+S[3]))+S[1]*(S[3]*(V[214]-3*V[213])+S[1]*(V[213]-V[214])))+S[3]*(
 V[18]*(S[2]*(V[213]-V[214])+S[1]*(V[214]-V[213]))));
C[50]=+V[15]*(2*(V[15]*(V[213]*(S[1]-S[2]+S[3])+V[214]*(S[1]-S[2]-S[3]))+
 V[18]*(V[213]*(S[1]-S[2]-S[3])+V[214]*(S[2]-S[1]-S[3])))+S[0]*(V[18]*(8*(
 V[214]+V[213]))))+S[3]*(S[2]*(2*(V[213]-V[214])));
C[49]=+V[15]*(V[18]*(4*(V[214]+V[213])));
C[48]=+V[527]*V[523]*V[458]*V[125]*S[18];
C[47]=+V[527]*V[523]*V[466]*V[427];
C[46]=+V[15]*(V[15]*(V[15]*(2*(V[18]-V[15]))+3*S[1]-S[2])+V[18]*(S[1]-
 S[2]));
C[45]=+2*(V[15]*(V[18]-V[15])-S[2]);
C[44]=+V[527]*V[523]*V[466]*V[464];
C[43]=+V[15]*(2*V[18]*V[15]+S[1]-S[2]);
C[42]=+2*V[18];
C[41]=+V[527]*V[523]*V[468]*V[439];
C[40]=+V[15]*(S[1]*(V[18]+V[16]+2*V[15])+S[2]*(-V[18]-V[16])+V[15]*(2*(
 V[18]*V[16]-S[0])));
C[39]=+2*(V[18]*V[16]-S[0]-S[2]);
C[38]=+V[527]*V[523]*V[485]*V[481];
C[37]=+V[15]*(S[1]*(V[18]+V[17]+2*V[15])+S[2]*(-V[18]-V[17])+V[15]*(2*(
 V[18]*V[17]-S[0])));
C[36]=+2*(V[18]*V[17]-S[0]-S[2]);
C[35]=+V[527]*V[523]*V[506]*V[502];
S[33]=V[18]*V[18];
...
S[35]=V[523]*V[523];
C[32]=+S[34]*S[35];
C[31]=+V[15]*(V[15]*(V[15]*(2*(V[15]*(V[213]*(S[1]-S[2]+S[3])+V[214]*(S[1]-
 S[2]-S[3]))+V[19]*(V[213]*(S[1]-S[2]-S[3])+V[214]*(S[2]-S[1]-S[3])))+S[0]*(
 V[19]*(4*(V[214]+V[213]))))+S[2]*(V[213]*(S[2]-2*S[1]+S[3])+V[214]*(2*S[1]-
 S[2]+S[3]))+S[1]*(S[3]*(V[214]-3*V[213])+S[1]*(V[213]-V[214])))+S[3]*(
 V[19]*(S[2]*(V[213]-V[214])+S[1]*(V[214]-V[213]))));
C[30]=+V[15]*(2*(V[15]*(V[213]*(S[1]-S[2]+S[3])+V[214]*(S[1]-S[2]-S[3]))+
 V[19]*(V[213]*(S[1]-S[2]-S[3])+V[214]*(S[2]-S[1]-S[3])))+S[0]*(V[19]*(8*(
 V[214]+V[213]))))+S[3]*(S[2]*(2*(V[213]-V[214])));
C[29]=+V[15]*(V[19]*(4*(V[214]+V[213])));
C[28]=+S[3]*(2*(S[2]*(V[214]-V[213])+S[1]*(V[213]-V[214]))+S[0]*(4*(V[214]-
 V[213])));
C[27]=+S[3]*(4*(V[214]-V[213]));
C[26]=+16*S[20]*S[21]*S[8]*S[14]*S[23]*S[24]*S[3];
C[25]=+V[548]*V[544]*V[458]*V[125]*S[18];
S[36]=V[122]*V[122]*V[122];
S[37]=V[121]*V[121]*V[121];
S[38]=V[7]*V[7]*V[7];
S[39]=V[3]*V[3]*V[3];
C[24]=+8*S[36]*S[37]*S[13]*S[38]*S[39]*V[1];
C[23]=+V[548]*V[544]*V[466]*V[427];
C[22]=+V[15]*(V[15]*(V[15]*(2*(V[19]-V[15]))+3*S[1]-S[2])+V[19]*(S[1]-
 S[2]));
C[21]=+2*(V[15]*(V[19]-V[15])-S[2]);
C[20]=+V[548]*V[544]*V[466]*V[464];
C[19]=+V[15]*(2*V[19]*V[15]+S[1]-S[2]);
C[18]=+2*V[19];
C[17]=+16*S[36]*S[37]*S[13]*S[38]*S[39]*V[1];
C[16]=+V[548]*V[544]*V[468]*V[439];
C[15]=+V[15]*(S[1]*(V[19]+V[16]+2*V[15])+S[2]*(-V[19]-V[16])+V[15]*(2*(
 V[19]*V[16]-S[0])));
C[14]=+2*(V[19]*V[16]-S[0]-S[2]);
C[13]=+V[548]*V[544]*V[485]*V[481];
C[12]=+V[15]*(S[1]*(V[19]+V[17]+2*V[15])+S[2]*(-V[19]-V[17])+V[15]*(2*(
 V[19]*V[17]-S[0])));
C[11]=+2*(V[19]*V[17]-S[0]-S[2]);
C[10]=+V[548]*V[544]*V[506]*V[502];
C[9]=+V[15]*(S[1]*(V[19]+V[18]+2*V[15])+S[2]*(-V[19]-V[18])+V[15]*(2*(V[19]*
 V[18]-S[0])));
C[8]=+2*(V[19]*V[18]-S[0]-S[2]);
C[7]=+2*(S[2]-S[1])+4*S[0];
C[6]=+V[548]*V[544]*V[527]*V[523];
