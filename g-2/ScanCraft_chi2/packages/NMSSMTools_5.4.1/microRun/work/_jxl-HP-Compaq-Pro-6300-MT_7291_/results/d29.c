...
extern DNN S29_omg_p25p25_u;
REAL S29_omg_p25p25_u(double GG, REAL * momenta,REAL*cb_coeff,int * err)
{REAL  ans=0;
REAL DP[6];
...
S[14]=V[477]*V[477];
C[84]=+S[13]*S[14];
C[83]=+V[552]*V[540]*V[468]*V[410];
C[82]=+V[531]*V[519]*V[468]*V[410];
C[81]=+V[510]*V[498]*V[468]*V[410];
C[80]=+V[489]*V[477]*V[468]*V[410];
S[15]=V[468]*V[468];
S[16]=V[410]*V[410];
C[79]=+S[15]*S[16];
C[78]=+V[15]*(2*V[19]*V[15]+S[2]-S[3]);
C[77]=+2*V[19];
C[76]=+V[552]*V[540]*V[466]*V[400];
C[75]=+V[15]*(2*V[18]*V[15]+S[2]-S[3]);
C[74]=+2*V[18];
C[73]=+V[531]*V[519]*V[466]*V[400];
C[72]=+V[15]*(2*V[17]*V[15]+S[2]-S[3]);
C[71]=+2*V[17];
C[70]=+V[510]*V[498]*V[466]*V[400];
C[69]=+V[15]*(2*V[16]*V[15]+S[2]-S[3]);
C[68]=+2*V[16];
C[67]=+V[489]*V[477]*V[466]*V[400];
S[17]=V[122]*V[122];
S[18]=V[121]*V[121];
S[19]=V[119]*V[119];
S[20]=V[7]*V[7];
...
C[43]=+V[468]*V[466]*V[462]*V[400]*V[15];
C[42]=+S[1]*(2*S[2]-S[3]);
C[41]=+S[3];
C[40]=+2*S[1]-S[2]+S[3];
...
C[38]=+S[15]*S[35];
S[36]=V[2]*V[2];
C[37]=+V[15]*(V[15]*(V[15]*(2*(V[15]*(V[211]*(S[2]-S[3]+S[36])+V[212]*(S[2]-
 S[3]-S[36]))+V[19]*(V[211]*(S[2]-S[3]-S[36])+V[212]*(S[3]-S[2]-S[36])))+
 S[1]*(V[19]*(4*(V[212]+V[211]))))+S[3]*(V[211]*(S[3]-2*S[2]+S[36])+V[212]*(
 2*S[2]-S[3]+S[36]))+S[2]*(S[36]*(V[212]-3*V[211])+S[2]*(V[211]-V[212])))+
 S[36]*(V[19]*(S[3]*(V[211]-V[212])+S[2]*(V[212]-V[211]))));
C[36]=+V[15]*(2*(V[15]*(V[211]*(S[2]-S[3]+S[36])+V[212]*(S[2]-S[3]-S[36]))+
 V[19]*(V[211]*(S[2]-S[3]-S[36])+V[212]*(S[3]-S[2]-S[36])))+S[1]*(V[19]*(8*(
 V[212]+V[211]))))+S[36]*(S[3]*(2*(V[211]-V[212])));
C[35]=+V[15]*(V[19]*(4*(V[212]+V[211])));
C[34]=+V[552]*V[540]*V[458]*V[126]*S[22];
C[33]=+V[15]*(V[15]*(V[15]*(2*(V[15]*(V[211]*(S[2]-S[3]+S[36])+V[212]*(S[2]-
 S[3]-S[36]))+V[18]*(V[211]*(S[2]-S[3]-S[36])+V[212]*(S[3]-S[2]-S[36])))+
 S[1]*(V[18]*(4*(V[212]+V[211]))))+S[3]*(V[211]*(S[3]-2*S[2]+S[36])+V[212]*(
 2*S[2]-S[3]+S[36]))+S[2]*(S[36]*(V[212]-3*V[211])+S[2]*(V[211]-V[212])))+
 S[36]*(V[18]*(S[3]*(V[211]-V[212])+S[2]*(V[212]-V[211]))));
C[32]=+V[15]*(2*(V[15]*(V[211]*(S[2]-S[3]+S[36])+V[212]*(S[2]-S[3]-S[36]))+
 V[18]*(V[211]*(S[2]-S[3]-S[36])+V[212]*(S[3]-S[2]-S[36])))+S[1]*(V[18]*(8*(
 V[212]+V[211]))))+S[36]*(S[3]*(2*(V[211]-V[212])));
C[31]=+V[15]*(V[18]*(4*(V[212]+V[211])));
C[30]=+V[531]*V[519]*V[458]*V[126]*S[22];
C[29]=+V[15]*(V[15]*(V[15]*(2*(V[15]*(V[211]*(S[2]-S[3]+S[36])+V[212]*(S[2]-
 S[3]-S[36]))+V[17]*(V[211]*(S[2]-S[3]-S[36])+V[212]*(S[3]-S[2]-S[36])))+
 S[1]*(V[17]*(4*(V[212]+V[211]))))+S[3]*(V[211]*(S[3]-2*S[2]+S[36])+V[212]*(
 2*S[2]-S[3]+S[36]))+S[2]*(S[36]*(V[212]-3*V[211])+S[2]*(V[211]-V[212])))+
 S[36]*(V[17]*(S[3]*(V[211]-V[212])+S[2]*(V[212]-V[211]))));
C[28]=+V[15]*(2*(V[15]*(V[211]*(S[2]-S[3]+S[36])+V[212]*(S[2]-S[3]-S[36]))+
 V[17]*(V[211]*(S[2]-S[3]-S[36])+V[212]*(S[3]-S[2]-S[36])))+S[1]*(V[17]*(8*(
 V[212]+V[211]))))+S[36]*(S[3]*(2*(V[211]-V[212])));
C[27]=+V[15]*(V[17]*(4*(V[212]+V[211])));
C[26]=+V[510]*V[498]*V[458]*V[126]*S[22];
C[25]=+V[15]*(V[15]*(V[15]*(2*(V[15]*(V[211]*(S[2]-S[3]+S[36])+V[212]*(S[2]-
 S[3]-S[36]))+V[16]*(V[211]*(S[2]-S[3]-S[36])+V[212]*(S[3]-S[2]-S[36])))+
 S[1]*(V[16]*(4*(V[212]+V[211]))))+S[3]*(V[211]*(S[3]-2*S[2]+S[36])+V[212]*(
 2*S[2]-S[3]+S[36]))+S[2]*(S[36]*(V[212]-3*V[211])+S[2]*(V[211]-V[212])))+
 S[36]*(V[16]*(S[3]*(V[211]-V[212])+S[2]*(V[212]-V[211]))));
C[24]=+V[15]*(2*(V[15]*(V[211]*(S[2]-S[3]+S[36])+V[212]*(S[2]-S[3]-S[36]))+
 V[16]*(V[211]*(S[2]-S[3]-S[36])+V[212]*(S[3]-S[2]-S[36])))+S[1]*(V[16]*(8*(
 V[212]+V[211]))))+S[36]*(S[3]*(2*(V[211]-V[212])));
C[23]=+V[15]*(V[16]*(4*(V[212]+V[211])));
C[22]=+V[489]*V[477]*V[458]*V[126]*S[22];
S[37]=V[118]*V[118];
C[21]=+8*V[122]*V[121]*S[27]*S[37]*V[7]*V[3]*S[36];
C[20]=+V[468]*V[458]*V[410]*V[126]*V[15]*V[1];
C[19]=+S[1]*(2*(V[211]*(S[2]-S[3]-S[36])+V[212]*(S[3]-S[2]-S[36]))+S[1]*(4*(
 V[212]+V[211])))+S[36]*(S[3]*(V[211]-V[212])+S[2]*(V[212]-V[211]));
C[18]=+2*(V[211]*(S[2]-S[3]-S[36])+V[212]*(S[3]-S[2]-S[36]))+S[1]*(8*(
 V[212]+V[211]));
C[17]=+4*(V[212]+V[211]);
C[16]=+16*V[122]*V[121]*S[27]*S[37]*V[7]*V[3]*S[36];
C[15]=+V[466]*V[458]*V[400]*V[126]*V[15]*V[1];
S[38]=V[15]*V[15]*V[15]*V[15];
S[39]=V[10]*V[10]*V[10]*V[10];
C[14]=+S[1]*(V[211]*(S[3]*(2*(S[36]-S[2])+S[3]-4*S[1])+S[2]*(4*(S[1]-S[36])+
 S[2])+4*S[38])+V[212]*(S[2]*(2*(S[3]+S[36])-S[2])+S[1]*(4*(S[1]-S[36]))-
 S[39]));
C[13]=+S[1]*(V[211]*(4*(S[2]-S[3])+8*S[1])+V[212]*(8*S[1]-4*S[36]))+S[36]*(
 S[3]*(2*(V[211]-V[212])));
C[12]=+S[1]*(4*(V[212]+V[211]));
C[11]=+S[36]*(2*(S[3]*(V[212]-V[211])+S[2]*(V[211]-V[212]))+S[1]*(4*(V[212]-
 V[211])));
C[10]=+S[36]*(4*(V[212]-V[211]));
C[9]=+16*S[17]*S[18]*S[32]*S[37]*S[20]*S[21]*S[36];
C[8]=+V[468]*V[462]*V[458]*V[126]*S[22];
S[40]=V[13]*V[13]*V[13]*V[13];
S[41]=V[212]*V[212];
C[7]=+S[1]*(S[1]*(V[211]*(V[211]*(4*(S[1]*(S[1]+S[2]-S[3]-S[36])+S[36]*(
 S[3]-S[2]))+S[3]*(S[3]-2*S[2])+S[40])+V[212]*(S[36]*(4*S[36]-8*S[1])+S[3]*(
 4*S[2]-2*S[3])+8*S[38]-2*S[40]))+S[41]*(4*(S[1]*(S[1]-S[2]+S[3]-S[36])+
 S[36]*(S[2]-S[3]))+S[3]*(S[3]-2*S[2])+S[40]))+S[36]*(V[211]*(S[2]*(2*(
 S[36]*(V[211]-V[212])+V[212]*S[2]+V[211]*S[3])-4*V[212]*S[3]-V[211]*S[2])+
 S[3]*(S[3]*(2*V[212]-V[211])-V[211]*S[36]))+S[41]*(S[3]*(2*S[2]-S[3]+
 S[36])-S[40])));
S[42]=V[2]*V[2]*V[2]*V[2];
C[6]=+S[1]*(V[211]*(V[211]*(S[3]*(S[3]-8*S[1]-2*S[2]+4*S[36])+S[2]*(8*S[1]+
 S[2]-4*S[36])+S[1]*(12*S[1]-8*S[36]))+V[212]*(S[36]*(4*S[36]-16*S[1])+S[3]*
 (4*S[2]-2*S[3])+24*S[38]-2*S[40]))+S[41]*(S[3]*(8*S[1]-2*S[2]+S[3]-4*
 S[36])+S[2]*(S[2]-8*S[1]+4*S[36])+S[1]*(12*S[1]-8*S[36])))+S[42]*(S[3]*(
 V[211]*(2*V[212]-V[211])-S[41]));
C[5]=+S[1]*(V[211]*(V[211]*(4*(S[2]-S[3]-S[36])+12*S[1])+V[212]*(24*S[1]-8*
 S[36]))+S[41]*(4*(S[3]-S[2]-S[36])+12*S[1]));
C[4]=+S[1]*(V[211]*(8*V[212]+4*V[211])+4*S[41]);
C[3]=+S[42]*(V[211]*(V[211]*(2*S[1]-S[2]+S[3])+V[212]*(2*(S[2]-S[3])-4*
 S[1]))+S[41]*(2*S[1]-S[2]+S[3]));
C[2]=+S[42]*(V[211]*(2*V[211]-4*V[212])+2*S[41]);
