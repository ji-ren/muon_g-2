...
extern DNN S20_omg_p25p25_u;
REAL S20_omg_p25p25_u(double GG, REAL * momenta,REAL*cb_coeff,int * err)
{REAL  ans=0;
REAL DP[6];
...
width[10]=0.; mass[10]=V[29];  Qtxt[10]="\1\3";
width[9]=0.; mass[9]=V[29];  Qtxt[9]="\1\4";
width[8]=0.; mass[8]=V[28];  Qtxt[8]="\1\3";
width[7]=0.; mass[7]=V[28];  Qtxt[7]="\1\4";
...
C[111]=+V[5]*(V[15]*(V[222]*(V[223]*(4*(S[0]+S[1])))));
S[4]=V[223]*V[223]*V[223];
S[5]=V[223]*V[223]*V[223]*V[223];
C[110]=+S[2]*(V[222]*(V[222]*(V[5]*(V[5]*(2*S[0]-S[1])+2*V[223]*V[222]*
 V[15])+S[2]*(2*S[0]+S[1]))+2*S[4]*V[15]*V[5])+S[5]*(S[2]-S[3]));
C[109]=+V[15]*(V[222]*(V[222]*(V[15]*(2*S[0]+S[1])+2*V[223]*V[222]*V[5])+2*
 S[4]*V[5])+S[5]*V[15])+4*S[0]*S[1]*S[3];
C[108]=+4*S[0]*S[1]*S[2];
C[107]=+4*S[0]*S[1];
C[106]=+S[2]*(V[15]*(V[222]*(V[222]*(V[15]*(2*S[0]+S[1])+4*V[223]*V[222]*
 V[5])+4*S[4]*V[5])+S[5]*V[15])+4*S[0]*S[1]*S[3]);
C[105]=+V[15]*(V[222]*(V[222]*(V[15]*(4*S[0]+2*S[1])+4*V[223]*V[222]*V[5])+
 4*S[4]*V[5])+2*S[5]*V[15]);
C[104]=+S[1]*(4*S[0]+2*S[1])+2*S[5];
C[103]=+S[1]*(2*S[0]+S[1])+S[5];
S[6]=V[221]*V[221];
C[102]=+S[3]*(S[2]*(V[220]*(V[223]*(V[223]*V[220]+2*V[222]*V[221]))+S[1]*
 S[6]));
C[101]=+V[5]*(V[15]*(2*(V[220]*(V[221]*(S[0]+S[1])+V[223]*V[222]*V[220])+
 V[223]*V[222]*S[6])));
C[100]=+S[2]*(V[220]*(V[222]*(V[5]*(V[5]*(2*V[223]*V[221]-V[222]*V[220])+2*
 V[222]*V[221]*V[15])+S[2]*(2*V[223]*V[221]+V[222]*V[220]))+2*S[0]*V[221]*
 V[15]*V[5])+S[6]*(S[0]*(S[2]-S[3])));
C[99]=+V[220]*(V[5]*(V[221]*(2*(V[15]*(S[0]+S[1])+V[223]*V[222]*V[5]))+S[0]*
 V[220]*V[5])+S[2]*(V[222]*(2*V[223]*V[221]+V[222]*V[220])))+S[6]*(S[0]*
 S[2]+S[1]*S[3]);
C[98]=+V[15]*(V[5]*(2*(V[220]*(V[221]*(S[0]+S[1])-V[223]*V[222]*V[220])-
 V[223]*V[222]*S[6]))+4*V[223]*V[222]*V[221]*V[220]*V[15]);
S[7]=V[220]*V[220];
C[97]=+4*S[6]*S[7]*S[2]*S[3];
C[96]=+V[5]*(V[15]*(V[220]*(V[221]*(4*(S[6]+S[7])))));
C[95]=+S[2]*(V[222]*(V[220]*(V[5]*(V[5]*(2*V[223]*V[221]-V[222]*V[220])+2*
 V[223]*V[220]*V[15])+S[2]*(2*V[223]*V[221]+V[222]*V[220]))+2*V[223]*S[6]*
 V[15]*V[5])+S[6]*(S[0]*(S[2]-S[3])));
C[94]=+V[222]*(V[5]*(V[221]*(V[5]*(2*V[223]*V[220]+V[222]*V[221])+2*V[223]*
 V[221]*V[15])+2*V[223]*S[7]*V[15])+S[2]*(V[220]*(2*V[223]*V[221]+V[222]*
 V[220])))+S[0]*(S[6]*S[2]+S[7]*S[3]);
C[93]=+V[15]*(V[5]*(2*(V[220]*(V[221]*(S[0]+S[1])-V[223]*V[222]*V[220])-
 V[223]*V[222]*S[6]))-4*V[223]*V[222]*V[221]*V[220]*V[15]);
C[92]=+4*V[223]*V[222]*V[221]*V[220];
C[91]=+S[2]*(V[5]*(V[220]*(V[223]*(2*(V[15]*(V[223]*V[221]+V[222]*V[220])+
 V[222]*V[221]*V[5])+V[223]*V[220]*V[5])+2*S[1]*V[221]*V[15])+S[6]*(V[222]*(
 2*V[223]*V[15]+V[222]*V[5])))+S[2]*(V[220]*(V[222]*(2*V[223]*V[221]+V[222]*
 V[220]))+S[0]*S[6]));
C[90]=+V[15]*(2*(V[5]*(V[220]*(V[221]*(S[0]+S[1])+V[223]*V[222]*V[220])+
 V[223]*V[222]*S[6])+V[15]*(S[0]*S[6]+S[1]*S[7]))+4*V[223]*V[222]*V[221]*
 V[220]*V[15]);
C[89]=+V[220]*(V[222]*(4*V[223]*V[221]+2*V[222]*V[220]))+2*S[0]*S[6];
C[88]=+V[220]*(V[222]*(2*V[223]*V[221]+V[222]*V[220]))+S[0]*S[6];
...
S[12]=V[221]*V[221]*V[221];
S[13]=V[221]*V[221]*V[221]*V[221];
C[86]=+S[2]*(V[220]*(V[220]*(V[5]*(V[5]*(2*S[6]-S[7])+2*V[221]*V[220]*
 V[15])+S[2]*(2*S[6]+S[7]))+2*S[12]*V[15]*V[5])+S[13]*(S[2]-S[3]));
C[85]=+V[15]*(V[220]*(V[220]*(V[15]*(2*S[6]+S[7])+2*V[221]*V[220]*V[5])+2*
 S[12]*V[5])+S[13]*V[15])+4*S[6]*S[7]*S[3];
C[84]=+4*S[6]*S[7]*S[2];
C[83]=+4*S[6]*S[7];
C[82]=+S[2]*(V[15]*(V[220]*(V[220]*(V[15]*(2*S[6]+S[7])+4*V[221]*V[220]*
 V[5])+4*S[12]*V[5])+S[13]*V[15])+4*S[6]*S[7]*S[3]);
C[81]=+V[15]*(V[220]*(V[220]*(V[15]*(4*S[6]+2*S[7])+4*V[221]*V[220]*V[5])+4*
...
C[72]=+S[20]*(V[5]*(S[0]+S[1])+2*V[223]*V[222]*V[15]);
C[71]=+V[15]*(V[5]*(S[0]+S[1])+4*V[223]*V[222]*V[15]);
C[70]=+2*V[223]*V[222]*S[2];
C[69]=+S[20]*(V[5]*(S[6]+S[7]));
C[68]=+V[5]*(V[15]*(S[6]+S[7]));
C[67]=+S[20]*(V[5]*(S[6]+S[7])+2*V[221]*V[220]*V[15]);
C[66]=+V[15]*(V[5]*(S[6]+S[7])+4*V[221]*V[220]*V[15]);
C[65]=+2*V[221]*V[220]*S[2];
...
C[54]=+S[2]*(V[5]*(V[15]*(S[0]+S[1])-2*V[223]*V[222]*V[5])+2*V[223]*V[222]*
 S[2]);
C[53]=+V[5]*(V[15]*(S[0]+S[1])+2*V[223]*V[222]*V[5])+2*V[223]*V[222]*S[2];
C[52]=+S[2]*(V[5]*(V[15]*(S[0]+S[1])+2*V[223]*V[222]*V[5]));
C[51]=+V[5]*(V[15]*(S[0]+S[1])-2*V[223]*V[222]*V[5])+2*V[223]*V[222]*S[2];
C[50]=+V[15]*(2*(V[5]*(S[0]+S[1])+V[223]*V[222]*V[15]));
C[49]=+2*V[223]*V[222];
C[48]=+S[2]*(V[5]*(V[15]*(S[6]+S[7])-2*V[221]*V[220]*V[5])+2*V[221]*V[220]*
 S[2]);
C[47]=+V[5]*(V[15]*(S[6]+S[7])+2*V[221]*V[220]*V[5])+2*V[221]*V[220]*S[2];
C[46]=+S[2]*(V[5]*(V[15]*(S[6]+S[7])+2*V[221]*V[220]*V[5]));
C[45]=+V[5]*(V[15]*(S[6]+S[7])-2*V[221]*V[220]*V[5])+2*V[221]*V[220]*S[2];
C[44]=+V[15]*(2*(V[5]*(S[6]+S[7])+V[221]*V[220]*V[15]));
C[43]=+2*V[221]*V[220];
S[28]=V[121]*V[121];
S[29]=V[118]*V[118];
...
C[33]=+S[2]*(S[35]*(V[5]*(V[5]*(S[34]*(2*(S[0]-S[1]))-6*S[0]-3*S[1])+6*
 V[223]*V[222]*V[15])+S[2]*(S[34]*(2*(S[0]-S[1]))+3*S[1]))+S[3]*(S[2]*(6*(
 S[0]+S[1]))));
C[32]=+S[35]*(S[34]*(2*(S[3]*(S[1]-S[0])+S[2]*(S[0]-S[1])))+V[5]*(V[223]*(3*
 V[223]*V[5]+6*V[222]*V[15]))+3*S[1]*S[2])+S[3]*(S[2]*(6*(S[0]+S[1])));
C[31]=+V[5]*(V[15]*(V[222]*(V[223]*(12*S[2]-18*S[35]))));
C[30]=+12*V[223]*V[222]*V[15]*V[5];
C[29]=+S[2]*(S[35]*(V[5]*(V[5]*(S[34]*(2*(S[1]-S[0]))+6*S[0]+3*S[1])+12*
 V[223]*V[222]*V[15])+S[2]*(S[34]*(2*(S[0]-S[1]))+3*S[1]))+S[2]*(V[5]*(V[5]*
 (6*(-S[0]-S[1]))-12*V[223]*V[222]*V[15])));
C[28]=+S[35]*(S[34]*(S[3]*(2*(S[0]-S[1]))+S[2]*(6*(S[0]-S[1])))+V[5]*(
 V[223]*(12*V[222]*V[15]-3*V[223]*V[5]))+9*S[1]*S[2])+S[2]*(V[5]*(V[5]*(6*(-
 S[0]-S[1]))-24*V[223]*V[222]*V[15]));
C[27]=+S[35]*(S[34]*(4*(S[0]-S[1]))+6*S[1])-12*V[223]*V[222]*V[15]*V[5];
C[26]=+V[15]*(S[35]*(V[15]*(S[34]*(8*(S[0]-S[1]))+12*S[1])+18*V[223]*V[222]*
 V[5])-12*V[223]*V[222]*S[2]*V[5]);
C[25]=+S[35]*(S[34]*(8*(S[0]-S[1]))+12*S[1])-12*V[223]*V[222]*V[15]*V[5];
C[24]=+S[35]*(S[34]*(4*(S[0]-S[1]))+6*S[1]);
C[23]=+S[2]*(S[35]*(V[5]*(V[5]*(S[34]*(2*(S[6]-S[7]))-6*S[6]-3*S[7])+6*
 V[221]*V[220]*V[15])+S[2]*(S[34]*(2*(S[6]-S[7]))+3*S[7]))+S[3]*(S[2]*(6*(
 S[6]+S[7]))));
C[22]=+S[35]*(S[34]*(2*(S[3]*(S[7]-S[6])+S[2]*(S[6]-S[7])))+V[5]*(V[221]*(3*
 V[221]*V[5]+6*V[220]*V[15]))+3*S[7]*S[2])+S[3]*(S[2]*(6*(S[6]+S[7])));
C[21]=+V[5]*(V[15]*(V[220]*(V[221]*(12*S[2]-18*S[35]))));
C[20]=+12*V[221]*V[220]*V[15]*V[5];
C[19]=+S[2]*(S[35]*(V[5]*(V[5]*(S[34]*(2*(S[7]-S[6]))+6*S[6]+3*S[7])+12*
 V[221]*V[220]*V[15])+S[2]*(S[34]*(2*(S[6]-S[7]))+3*S[7]))+S[2]*(V[5]*(V[5]*
 (6*(-S[6]-S[7]))-12*V[221]*V[220]*V[15])));
C[18]=+S[35]*(S[34]*(S[3]*(2*(S[6]-S[7]))+S[2]*(6*(S[6]-S[7])))+V[5]*(
 V[221]*(12*V[220]*V[15]-3*V[221]*V[5]))+9*S[7]*S[2])+S[2]*(V[5]*(V[5]*(6*(-
 S[6]-S[7]))-24*V[221]*V[220]*V[15]));
C[17]=+S[35]*(S[34]*(4*(S[6]-S[7]))+6*S[7])-12*V[221]*V[220]*V[15]*V[5];
C[16]=+V[15]*(S[35]*(V[15]*(S[34]*(8*(S[6]-S[7]))+12*S[7])+18*V[221]*V[220]*
 V[5])-12*V[221]*V[220]*S[2]*V[5]);
C[15]=+S[35]*(S[34]*(8*(S[6]-S[7]))+12*S[7])-12*V[221]*V[220]*V[15]*V[5];
