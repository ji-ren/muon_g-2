...
extern DNN S12_omg_p25p25_u;
REAL S12_omg_p25p25_u(double GG, REAL * momenta,REAL*cb_coeff,int * err)
{REAL  ans=0;
REAL DP[6];
...
REAL Q0[4]; COMPLEX Q1[4]; REAL Q2[4];
 if(momenta)
 {width[3]=0.; mass[3]=V[40];  Qtxt[3]="\1\3";
width[2]=0.; mass[2]=V[40];  Qtxt[2]="\1\4";
