...
extern DNN S15_omg_p25p25_u;
REAL S15_omg_p25p25_u(double GG, REAL * momenta,REAL*cb_coeff,int * err)
{REAL  ans=0;
REAL DP[6];
...
REAL Q0[6]; COMPLEX Q1[6]; REAL Q2[6];
 if(momenta)
 {width[5]=0.; mass[5]=V[37];  Qtxt[5]="\1\3";
width[4]=0.; mass[4]=V[37];  Qtxt[4]="\1\4";
width[3]=0.; mass[3]=V[36];  Qtxt[3]="\1\3";
width[2]=0.; mass[2]=V[36];  Qtxt[2]="\1\4";
