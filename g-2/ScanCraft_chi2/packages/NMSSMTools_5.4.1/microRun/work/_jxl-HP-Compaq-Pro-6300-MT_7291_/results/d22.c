...
extern DNN S22_omg_p25p25_u;
REAL S22_omg_p25p25_u(double GG, REAL * momenta,REAL*cb_coeff,int * err)
{REAL  ans=0;
REAL DP[6];
...
width[10]=0.; mass[10]=V[31];  Qtxt[10]="\1\3";
width[9]=0.; mass[9]=V[31];  Qtxt[9]="\1\4";
width[8]=0.; mass[8]=V[30];  Qtxt[8]="\1\3";
width[7]=0.; mass[7]=V[30];  Qtxt[7]="\1\4";
...
C[114]=+V[15]*(V[128]*(V[226]*(V[227]*(4*(S[0]+S[1])))));
S[4]=V[227]*V[227]*V[227];
S[5]=V[227]*V[227]*V[227]*V[227];
C[113]=+S[3]*(V[226]*(V[226]*(V[15]*(V[15]*(-2*S[0]-S[1])-2*V[227]*V[226]*
 V[128])+S[2]*(S[1]-2*S[0]))-2*S[4]*V[128]*V[15])+S[5]*(S[2]-S[3]));
C[112]=+V[15]*(V[226]*(V[226]*(V[15]*(2*S[0]+S[1])+2*V[227]*V[226]*V[128])+
 2*S[4]*V[128])+S[5]*V[15])+4*S[0]*S[1]*S[2];
C[111]=+4*S[0]*S[1]*S[3];
C[110]=+4*S[0]*S[1];
C[109]=+S[3]*(V[15]*(V[226]*(V[226]*(V[15]*(2*S[0]+S[1])+4*V[227]*V[226]*
 V[128])+4*S[4]*V[128])+S[5]*V[15])+4*S[0]*S[1]*S[2]);
C[108]=+V[15]*(V[226]*(V[226]*(V[15]*(4*S[0]+2*S[1])+4*V[227]*V[226]*
 V[128])+4*S[4]*V[128])+2*S[5]*V[15]);
C[107]=+S[1]*(4*S[0]+2*S[1])+2*S[5];
C[106]=+S[1]*(2*S[0]+S[1])+S[5];
S[6]=V[225]*V[225];
C[105]=+S[3]*(S[2]*(V[224]*(V[227]*(V[227]*V[224]+2*V[226]*V[225]))+S[1]*
 S[6]));
C[104]=+V[15]*(V[128]*(2*(V[224]*(V[225]*(S[0]+S[1])+V[227]*V[226]*V[224])+
 V[227]*V[226]*S[6])));
C[103]=+S[3]*(V[224]*(V[226]*(V[15]*(V[15]*(-2*V[227]*V[225]-V[226]*V[224])-
 2*V[226]*V[225]*V[128])+S[2]*(V[226]*V[224]-2*V[227]*V[225]))-2*S[0]*
 V[225]*V[128]*V[15])+S[6]*(S[0]*(S[2]-S[3])));
C[102]=+V[224]*(V[15]*(V[225]*(2*(V[128]*(S[0]+S[1])+V[227]*V[226]*V[15]))+
 S[1]*V[224]*V[15])+S[2]*(V[227]*(V[227]*V[224]+2*V[226]*V[225])))+S[6]*(
 S[0]*S[3]+S[1]*S[2]);
C[101]=+V[15]*(V[128]*(2*(V[224]*(V[225]*(S[0]+S[1])-V[227]*V[226]*V[224])-
 V[227]*V[226]*S[6]))+4*V[227]*V[226]*V[225]*V[224]*V[15]);
S[7]=V[224]*V[224];
C[100]=+4*S[6]*S[7]*S[2]*S[3];
C[99]=+V[15]*(V[128]*(V[224]*(V[225]*(4*(S[6]+S[7])))));
C[98]=+S[3]*(V[226]*(V[224]*(V[15]*(V[15]*(-2*V[227]*V[225]-V[226]*V[224])-
 2*V[227]*V[224]*V[128])+S[2]*(V[226]*V[224]-2*V[227]*V[225]))-2*V[227]*
 S[6]*V[128]*V[15])+S[6]*(S[0]*(S[2]-S[3])));
C[97]=+V[226]*(V[15]*(V[224]*(V[15]*(2*V[227]*V[225]+V[226]*V[224])+2*
 V[227]*V[224]*V[128])+2*V[227]*S[6]*V[128])+S[2]*(V[225]*(2*V[227]*V[224]+
 V[226]*V[225])))+S[0]*(S[6]*S[3]+S[7]*S[2]);
C[96]=+V[15]*(V[128]*(2*(V[224]*(V[225]*(S[0]+S[1])-V[227]*V[226]*V[224])-
 V[227]*V[226]*S[6]))-4*V[227]*V[226]*V[225]*V[224]*V[15]);
C[95]=+4*V[227]*V[226]*V[225]*V[224];
C[94]=+S[3]*(V[15]*(V[224]*(V[226]*(2*(V[128]*(V[227]*V[224]+V[226]*V[225])+
 V[227]*V[225]*V[15])+V[226]*V[224]*V[15])+2*S[0]*V[225]*V[128])+S[6]*(
 V[227]*(V[227]*V[15]+2*V[226]*V[128])))+S[2]*(V[224]*(V[227]*(V[227]*
 V[224]+2*V[226]*V[225]))+S[1]*S[6]));
C[93]=+V[15]*(2*(V[128]*(V[224]*(V[225]*(S[0]+S[1])+V[227]*V[226]*V[224])+
 V[227]*V[226]*S[6])+V[15]*(S[0]*S[6]+S[1]*S[7]))+4*V[227]*V[226]*V[225]*
 V[224]*V[15]);
C[92]=+V[224]*(V[226]*(4*V[227]*V[225]+2*V[226]*V[224]))+2*S[0]*S[6];
C[91]=+V[224]*(V[226]*(2*V[227]*V[225]+V[226]*V[224]))+S[0]*S[6];
...
S[12]=V[225]*V[225]*V[225];
S[13]=V[225]*V[225]*V[225]*V[225];
C[89]=+S[3]*(V[224]*(V[224]*(V[15]*(V[15]*(-2*S[6]-S[7])-2*V[225]*V[224]*
 V[128])+S[2]*(S[7]-2*S[6]))-2*S[12]*V[128]*V[15])+S[13]*(S[2]-S[3]));
C[88]=+V[15]*(V[224]*(V[224]*(V[15]*(2*S[6]+S[7])+2*V[225]*V[224]*V[128])+2*
 S[12]*V[128])+S[13]*V[15])+4*S[6]*S[7]*S[2];
C[87]=+4*S[6]*S[7]*S[3];
C[86]=+4*S[6]*S[7];
C[85]=+S[3]*(V[15]*(V[224]*(V[224]*(V[15]*(2*S[6]+S[7])+4*V[225]*V[224]*
 V[128])+4*S[12]*V[128])+S[13]*V[15])+4*S[6]*S[7]*S[2]);
C[84]=+V[15]*(V[224]*(V[224]*(V[15]*(4*S[6]+2*S[7])+4*V[225]*V[224]*V[128])+
 4*S[12]*V[128])+2*S[13]*V[15]);
...
C[80]=+S[14];
S[15]=V[1]*V[1]*V[1];
C[79]=+V[468]*V[128]*V[126]*S[15];
S[16]=V[468]*V[468];
S[17]=V[126]*V[126];
S[18]=V[1]*V[1];
C[78]=+3*S[16]*S[2]*S[17]*S[18];
S[19]=V[15]*V[15]*V[15];
C[77]=+S[19]*(V[128]*(S[0]+S[1]));
C[76]=+V[15]*(V[128]*(S[0]+S[1]));
C[75]=+S[19]*(V[128]*(S[0]+S[1])+2*V[227]*V[226]*V[15]);
C[74]=+V[15]*(V[128]*(S[0]+S[1])+4*V[227]*V[226]*V[15]);
C[73]=+2*V[227]*V[226]*S[3];
C[72]=+S[19]*(V[128]*(S[6]+S[7]));
C[71]=+V[15]*(V[128]*(S[6]+S[7]));
C[70]=+S[19]*(V[128]*(S[6]+S[7])+2*V[225]*V[224]*V[15]);
C[69]=+V[15]*(V[128]*(S[6]+S[7])+4*V[225]*V[224]*V[15]);
C[68]=+2*V[225]*V[224]*S[3];
S[20]=V[121]*V[121]*V[121];
S[21]=V[118]*V[118];
C[67]=+12*V[122]*S[20]*S[9]*S[21]*V[7]*V[6]*S[11];
C[66]=+V[466]*V[128]*V[125]*S[15];
S[22]=V[122]*V[122];
S[23]=V[121]*V[121];
S[24]=V[7]*V[7];
S[25]=V[6]*V[6];
...
C[59]=+V[464]*V[128]*V[95]*S[15];
S[29]=V[464]*V[464];
S[30]=V[95]*V[95];
C[58]=+3*S[29]*S[2]*S[30]*S[18];
C[57]=+V[462]*V[128]*V[92]*S[15];
C[56]=+3*V[464]*V[462]*S[2]*V[95]*V[92]*S[18];
S[31]=V[462]*V[462];
S[32]=V[92]*V[92];
C[55]=+3*S[31]*S[2]*S[32]*S[18];
C[54]=+S[3]*(V[15]*(V[128]*(S[0]+S[1])+2*V[227]*V[226]*V[15])-2*V[227]*
 V[226]*S[2]);
C[53]=+V[15]*(V[128]*(S[0]+S[1])+2*V[227]*V[226]*V[15])+2*V[227]*V[226]*
 S[2];
C[52]=+S[3]*(V[128]*(V[15]*(S[0]+S[1])+2*V[227]*V[226]*V[128]));
C[51]=+V[15]*(V[128]*(S[0]+S[1])+2*V[227]*V[226]*V[15])-2*V[227]*V[226]*
 S[2];
C[50]=+V[15]*(2*(V[128]*(S[0]+S[1])+V[227]*V[226]*V[15]));
C[49]=+2*V[227]*V[226];
C[48]=+S[3]*(V[15]*(V[128]*(S[6]+S[7])+2*V[225]*V[224]*V[15])-2*V[225]*
 V[224]*S[2]);
C[47]=+V[15]*(V[128]*(S[6]+S[7])+2*V[225]*V[224]*V[15])+2*V[225]*V[224]*
 S[2];
C[46]=+S[3]*(V[128]*(V[15]*(S[6]+S[7])+2*V[225]*V[224]*V[128]));
C[45]=+V[15]*(V[128]*(S[6]+S[7])+2*V[225]*V[224]*V[15])-2*V[225]*V[224]*
 S[2];
C[44]=+V[15]*(2*(V[128]*(S[6]+S[7])+V[225]*V[224]*V[15]));
C[43]=+2*V[225]*V[224];
C[42]=+12*V[122]*S[8]*S[9]*S[21]*V[7]*S[11];
C[41]=+V[460]*V[128]*V[89]*S[15];
...
S[35]=V[119]*V[119];
S[36]=V[2]*V[2];
C[33]=+S[3]*(S[36]*(V[128]*(V[128]*(S[35]*(4*(S[0]-S[1]))-6*S[0]-3*S[1])+6*
 V[227]*V[226]*V[15])+S[3]*(S[35]*(4*(S[0]-S[1]))+3*S[1]))+S[3]*(S[2]*(6*(
 S[0]+S[1]))));
C[32]=+S[36]*(S[35]*(4*(S[3]*(S[1]-S[0])+S[2]*(S[0]-S[1])))+V[15]*(V[226]*(-
 6*V[227]*V[128]-3*V[226]*V[15]))-3*S[0]*S[2])+S[3]*(S[2]*(6*(-S[0]-S[1])));
C[31]=+V[15]*(V[128]*(V[226]*(V[227]*(12*S[3]-18*S[36]))));
C[30]=+12*V[227]*V[226]*V[128]*V[15];
C[29]=+S[3]*(S[36]*(V[128]*(V[128]*(S[35]*(4*(S[0]-S[1]))-6*S[0]-3*S[1])-12*
 V[227]*V[226]*V[15])+S[3]*(S[35]*(4*(S[1]-S[0]))-3*S[1]))+S[3]*(V[128]*(
 V[128]*(6*(S[0]+S[1]))+12*V[227]*V[226]*V[15])));
C[28]=+S[36]*(S[35]*(S[3]*(12*(S[0]-S[1]))+S[2]*(4*(S[0]-S[1])))+V[15]*(
 V[226]*(12*V[227]*V[128]+9*V[226]*V[15]))-3*S[0]*S[2])+S[3]*(V[128]*(
 V[128]*(6*(-S[0]-S[1]))-24*V[227]*V[226]*V[15]));
C[27]=+S[36]*(S[35]*(8*(S[0]-S[1]))+6*S[1])-12*V[227]*V[226]*V[128]*V[15];
C[26]=+V[15]*(S[36]*(V[15]*(S[35]*(16*(S[0]-S[1]))+12*S[1])+18*V[227]*
 V[226]*V[128])-12*V[227]*V[226]*V[128]*S[3]);
C[25]=+S[36]*(S[35]*(16*(S[0]-S[1]))+12*S[1])-12*V[227]*V[226]*V[128]*V[15];
C[24]=+S[36]*(S[35]*(8*(S[0]-S[1]))+6*S[1]);
C[23]=+S[3]*(S[36]*(V[128]*(V[128]*(S[35]*(4*(S[6]-S[7]))-6*S[6]-3*S[7])+6*
 V[225]*V[224]*V[15])+S[3]*(S[35]*(4*(S[6]-S[7]))+3*S[7]))+S[3]*(S[2]*(6*(
 S[6]+S[7]))));
C[22]=+S[36]*(S[35]*(4*(S[3]*(S[7]-S[6])+S[2]*(S[6]-S[7])))+V[15]*(V[224]*(-
 6*V[225]*V[128]-3*V[224]*V[15]))-3*S[6]*S[2])+S[3]*(S[2]*(6*(-S[6]-S[7])));
C[21]=+V[15]*(V[128]*(V[224]*(V[225]*(12*S[3]-18*S[36]))));
C[20]=+12*V[225]*V[224]*V[128]*V[15];
C[19]=+S[3]*(S[36]*(V[128]*(V[128]*(S[35]*(4*(S[6]-S[7]))-6*S[6]-3*S[7])-12*
 V[225]*V[224]*V[15])+S[3]*(S[35]*(4*(S[7]-S[6]))-3*S[7]))+S[3]*(V[128]*(
 V[128]*(6*(S[6]+S[7]))+12*V[225]*V[224]*V[15])));
C[18]=+S[36]*(S[35]*(S[3]*(12*(S[6]-S[7]))+S[2]*(4*(S[6]-S[7])))+V[15]*(
 V[224]*(12*V[225]*V[128]+9*V[224]*V[15]))-3*S[6]*S[2])+S[3]*(V[128]*(
 V[128]*(6*(-S[6]-S[7]))-24*V[225]*V[224]*V[15]));
C[17]=+S[36]*(S[35]*(8*(S[6]-S[7]))+6*S[7])-12*V[225]*V[224]*V[128]*V[15];
C[16]=+V[15]*(S[36]*(V[15]*(S[35]*(16*(S[6]-S[7]))+12*S[7])+18*V[225]*
 V[224]*V[128])-12*V[225]*V[224]*V[128]*S[3]);
C[15]=+S[36]*(S[35]*(16*(S[6]-S[7]))+12*S[7])-12*V[225]*V[224]*V[128]*V[15];
